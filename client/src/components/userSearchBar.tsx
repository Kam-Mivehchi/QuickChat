...
function UserSearchBar({ page }: { page: string }) {
   ...
   return (
      <div>
         ...
         <div className={`relative transition-transform duration-200 ease-in ${openSearch ? "translate-x-0" : "translate-x-[100vw]"} z-40 `}>
            ...
            justify-center items-between pt-24 lg:pt-48">
